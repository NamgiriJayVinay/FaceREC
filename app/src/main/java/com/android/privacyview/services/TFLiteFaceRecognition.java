...
import com.android.privacyview.db.DBHelper;
import com.android.privacyview.ui.FaceDetection;
...
//        registered = dbHelper.getAllFaces();
    ...
    private Pair<String, Float> findNearest(float[] emb) {
        ...
        for (Map.Entry<String, Recognition> entry : FaceDetection.registered.entrySet()) {
    ...
    public Recognition recognizeImage(final Bitmap bitmap, boolean storeExtra) {
        ...
        if (FaceDetection.registered.size() > 0) {
